...
## Reusable rich-text table (`.umd-text-rich-table-*`)
...
The renderer uses a semantic row header in the first column by default. Set `row_headers=False` for equal-data column sets.
