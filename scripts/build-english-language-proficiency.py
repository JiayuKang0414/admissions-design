  ...
  <main id="main-content">
    <section>
      <umd-element-hero-minimal data-theme="dark">
        <img slot="image" src="../../images/how-to-apply/english-language-proficiency-hero.svg?v=black-neutrals" alt="" />
...
assert 'src="../../images/how-to-apply/english-language-proficiency-hero.svg?v=black-neutrals" alt=""' in output
